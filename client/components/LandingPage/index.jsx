  ...
  <div id="landing-page-component">
    <div id="index-banner" className="parallax-container">
      <div className="section no-pad-bot">
        <div className="container">
          ...
          <div className="center">
            <h5 className="header col blue-grey-text text-darken-4 s12">
              We Know You Love to Try New things.... Especially New Tastes
            </h5>
          </div>
          <div className="center">
            <a
              id="btn-browse-catalog"
              className="btn-large waves-effect waves-light grey darken-4 lighten-1"
            >
              Browse Catalog
            </a>
          </div>
      ...
      <div className="parallax">
        <img src={BannerBackground} alt="Unsplashed background img 1" />
      </div>
    </div>
    {/* Banner Section End */}
        ...
        <div id="" className="row">
          ...
          <div className="col s12 m4">
            <div className="icon-block">
              ...
              <p className="light">
                Browse through a rich base of interesting and exciting recipes
                 from lovers of new tastes like you
              </p>
            </div>
          </div>
          ...
          <div className="col s12 m4">
            <div className="icon-block">
              ...
              <p className="light">
                You love discovering new tastes and exciting combinations -
                 Share sensational discoveries with other taste lovers and get
                 exciting reviews that drives you to do more
              </p>
            </div>
          </div>
          ...
          <div className="col s12 m4">
            <div className="icon-block">
              ...
              <p className="light">
                Rate, assess, react, suggest....... and recipes can even be tran
                sformed into stimulating adventures.
              </p>
            </div>
          </div>
        </div>
